...
This unit establishes the analytical foundation required for data structures and algorithms.
The emphasis is on **algorithm behavior and complexity**, demonstrated through C++ code.

---

## 📂 File Index

- [`primitive-data-types.cpp`](primitive-data-types.cpp) — Memory usage and data ranges  
...
- How algorithms scale with input
